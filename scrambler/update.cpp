...
#define ERROR_TIP_UPDATE_FILE_ERROR __t( "Update service configure error, please report to: ( email:" ) BITSAFE_EMAIL __t( " bbs:simpai.net/bbs ),thanks very much." )
#define DONT_NEED_UPDATE_TEXT L"You are using newest version, don't need to update."
#else
#define ERROR_TIP_CANT_DOWNLOAD_UPDATE_FILE L"获取更新信息失败,请检查网络连接.如果网络连接没有问题,请手动从链接\"http://www.simpai.net/bitsafev2.zip\"下载或等待服务器维护完毕."
...
#define ERROR_TIP_UPDATE_FILE_ERROR L"更新服务配置有问题,请向管理员报告此情况( email:" BITSAFE_EMAIL L" bbs:simpai.net/bbs ),谢谢."
